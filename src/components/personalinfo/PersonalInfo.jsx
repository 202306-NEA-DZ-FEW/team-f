...
const PersonalInfo = () => {
    return (
        <div>
            <div className='flex lg:justify-start flex-wrap justify-center lg:flex-col'>
                <svg className='m-4' width={230} height={230}>
                ...
                <div className='mt-24 text-xl mr-10 lg:my-2 lg:ml-10'>
                    <span>Name Surname</span>
                    <p>Location</p>
                </div>
                <div className='w-3/4 h-60 m-6 bg-neutral-100 rounded-3xl'>
                    ...
                    <span className="text-2xl text-zinc-700 font-bold flex justify-center">My items</span>
                    <div className="w-96 h-28 bg-neutral-100 rounded-3xl">
                    {/* <Image width={500} height={500} className="w-20 h-12 rounded-2xl" src="/public/images/2.png" alt="item" /> */}
                        <p>Item title</p>
                        <button></button>
                        <button></button>
