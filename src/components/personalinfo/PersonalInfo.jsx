...
const PersonalInfo = () => {
    return (
        <div className='flex lg:flex-cols-2 flex-wrap lg:flex-nowrap bg-red gap-1'>
            <div className='flex flex-wrap justify-center lg:w-64 '>
                <svg className='ml-8 mt-4 flex justify-center' width={230} height={230}>
            ...
            <div className='w-3/4 lg:h-60 h-80 m-6 bg-neutral-100 rounded-3xl lg:ml-72 lg:mt-6'>
            ...
            {/* <span className='text-2xl text-zinc-700 font-bold flex justify-center'>
                        My items
                    </span>
